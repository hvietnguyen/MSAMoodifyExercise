class Mood{
    name: string;    
    emoij: string;
    constructor(public mood, public emoijurl){
        this.name = mood;
        this.emoij = emoijurl;
    }
}
...
var pageheader:HTMLBlockElement = <HTMLBlockElement>$("#page-header")[0]; //note the [0], jQuery returns an object, so to get the html DOM object we need the first item in the object
var pagecontainer:HTMLBlockElement = <HTMLBlockElement>$("#page-container")[0];
var imgSelector:HTMLInputElement = <HTMLInputElement>$("#my-file-selector")[0];
var refreshbtn:HTMLButtonElement = <HTMLButtonElement>$("#refreshbtn")[0];
...
function changeUI() : void {
    ...
    //Show mood emoji
    var img:HTMLImageElement = <HTMLImageElement>$("#selected_img")[0];//getting a predefined area on our webpage to show the emoji
